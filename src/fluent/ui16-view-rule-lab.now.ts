...
export const x_144721_family_ap_ui16_request = Table({
    ...
    schema: {
        ...
        source_summary: StringColumn({ label: '学校からの連絡内容', maxLength: 4000 }),
        requested_action: StringColumn({ label: '対応してほしいこと', maxLength: 4000 }),
        parent_comment: StringColumn({ label: '保護者コメント', maxLength: 4000 }),
        internal_note: StringColumn({ label: '検証メモ', maxLength: 4000 }),
